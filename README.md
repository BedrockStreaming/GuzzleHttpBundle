...
m6web_guzzlehttp:
    clients:
        default:
            ...
            request_defaults:                # default request options, all request option available
                auth: ['user', 'password']   # e.g. authentication
                verify: true                 # e.g. SSL certificate verification
                                             # etc.
        otherclient:
            ...
```
