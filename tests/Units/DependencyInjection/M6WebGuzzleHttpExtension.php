...
class M6WebGuzzleHttpExtension extends \atoum
{
    ...
    public function testMultiClientSameHandlerConfig()
    {
        ...
        $this
            ...
            ->boolean($arguments['allow_redirects'])
                ->isFalse()
            // TODO: find why alias is not set
            ...
            ->boolean($container->has('m6web_guzzlehttp.guzzle.handlerstack.myclient'))
                ->isTrue()
            ->boolean($container->get('m6web_guzzlehttp.guzzle.handlerstack.myclient') === $container->get('m6web_guzzlehttp.guzzle.handlerstack.default'))
                ->isTrue()
        ;
    }
    ...
    public function testMultiClientConfig()
    {
        ...
        $this
            ...
            ->boolean($container->has('m6web_guzzlehttp.guzzle.handlerstack.myclient'))
            ->isTrue()
            // @TODO: find a way to make sure our handlerstack is the same for all our clients
            ->boolean($container->get('m6web_guzzlehttp.guzzle.handlerstack.myclient') !== $container->get('m6web_guzzlehttp.guzzle.handlerstack.default'))
            ->isTrue()
        ;
    }
